...
# ambi = ambient.Ambient(60090, "b314d119d035d9de")
...
#   logging.info("send time at "+str(send_minute)+"m")
  ...
  while True:
    ...
    # while time_to_send:
    id_to_send = str(int(id_to_send)+1).zfill(8)
    id_message = id_to_send + "\r\n"
    # time_ambi = str(datetime.datetime.fromtimestamp(int(id_to_send)).strftime('%Y-%m-%d %H:%M:%S'))
    send_req(id_message)
