...
//  Serial.println((voltage-1.058)/0.009);
  Serial.println(data0001);
  data0001 = "d,0001,"+sensorstring+","+sensorstring2+","+temp+","+String(rtc.now().unixtime());
...
void loop() {
    ...
    for(int i=2;i<4;i++){
        ...
        String custom_data = "r," + i_string + "," + datetosend;
